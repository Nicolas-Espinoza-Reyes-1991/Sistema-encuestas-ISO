...
<div class="fade show">
<button onclick="saveAndEdit('encuestaForm','','{{$selectGet ? $selectGet->id_encuesta3:''}}','2')" class="btn-flotante btn btn-md btn-primary pulse" data-toggle="tooltip" data-placement="top" title="Guardar de forma temporal"><i class="fas fa-save"></i></button>
    ...
    @foreach ($Selectores as $select) 
        ...
        @endif
            ...
            <div class="col-lg-3 mb-3">
                <label for="" class="form-label pb-2 fw-bold fw-bold">Acceso exclusivo</label>
            ...
            <div class="col-lg-4 mb-3">
                <label for="" class="form-label pb-2 fw-bold fw-bold">Acceso ilimitado</label>
    ...
    <div class="row">
        <div class="col-12 pe-0">
                ...
                onclick="saveAndEdit('encuestaForm','','{{$selectGet ? $selectGet->id_encuesta3:''}}','1')">Enviar mis respuestas <i class="fas fa-share"></i></button>
